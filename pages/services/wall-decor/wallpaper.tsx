  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={getAbsoluteMediaUrl(WALLPAPER_HERO_IMAGE, SITE_URL)} />
        ...
        <meta name="twitter:image" content={getAbsoluteMediaUrl(WALLPAPER_HERO_IMAGE, SITE_URL)} />
      </Head>
