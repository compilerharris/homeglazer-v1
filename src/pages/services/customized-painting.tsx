        ...
        <div className="w-[90%] lg:w-[80%] mx-auto">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/services/customized">Customized Painting</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <section className="w-[90%] lg:w-[80%] mx-auto my-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow">
              <img 
                src="public/lovable-uploads/e3ab82c7-64c8-4752-bf46-aa749ac0264e.png" 
              ...
              <div className="p-6 bg-gray-50">
                ...
                <Link 
                  href="/services/customized/exterior-painting"
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow">
              ...
              <div className="p-6 bg-gray-50">
                ...
                <Link 
                  href="/services/customized/interior-painting"
                  className="flex items-center justify-center bg-[#ed276e] hover:bg-[#3b82f6] text-white rounded-full py-3 px-6 transition-colors"
                >
                  Learn More
                  <ArrowRight className="ml-2" size={20} />
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow">
              ...
              <div className="p-6 bg-gray-50">
                ...
                <Link 
                  href="/services/customized/one-day-painting"
                  className="flex items-center justify-center bg-[#ed276e] hover:bg-[#3b82f6] text-white rounded-full py-3 px-6 transition-colors"
                >
                  Learn More
                  <ArrowRight className="ml-2" size={20} />
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow">
              ...
              <div className="p-6 bg-gray-50">
                ...
                <Link 
                  href="/services/customized/per-day-painting"
                  className="flex items-center justify-center bg-[#ed276e] hover:bg-[#3b82f6] text-white rounded-full py-3 px-6 transition-colors"
                >
                  Learn More
                  <ArrowRight className="ml-2" size={20} />
