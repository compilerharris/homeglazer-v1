  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 pt-16 pb-24 flex flex-col items-center justify-center">
        ...
        <p className="text-lg text-gray-700 mb-12 text-center max-w-xl">Choose a visualiser mode to explore how different paint colours will look in your space. Start with the Single Wall Visualiser for quick previews, or try the Advanced Visualiser for more customization.</p>
        <div className="flex flex-col md:flex-row gap-8 w-full max-w-2xl justify-center items-center">
          <div className="bg-white rounded-xl shadow-lg p-8 flex-1 flex flex-col items-center hover:shadow-2xl transition">
            <span className="text-2xl font-semibold text-[#299dd7] mb-4">Single Wall Visualiser</span>
            <p className="text-gray-600 text-center mb-4">Quickly preview popular colour combinations on sample rooms. Simple and fast!</p>
            <Link href="/colour-visualiser/basic" className="mt-auto px-6 py-2 rounded-full bg-[#299dd7] text-white font-medium hover:bg-[#237bb0] transition text-center w-full cursor-pointer">Try Single Wall Visualiser</Link>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-8 flex-1 flex flex-col items-center hover:shadow-2xl transition">
            ...
            <Link href="/colour-visualiser/advanced" className="mt-auto px-6 py-2 rounded-full bg-[#ED276E] text-white font-medium hover:bg-[#b81d5a] transition text-center w-full cursor-pointer">Try Advanced Visualiser</Link>
          </div>
        </div>
      </main>
